...
class Game():
    ...
    def initialize_game(self):
        ...
        '''Manuually control initial state to test certain conditions here'''
        '''------------------------------------'''
        # p1_index, p2_index = (1, 1), (2, 1)
        ...
        # self.grid.trap((0, 0))
        # self.grid.trap((0, 1)); self.grid.trap((0, 2)); self.grid.trap((0, 3))
        # self.grid.trap((1, 0)); self.grid.trap((2, 0)); self.grid.trap((3, 0))
        # self.grid.trap((3, 0)); self.grid.trap((3, 1)); self.grid.trap((3, 2))
        # self.grid.trap((3, 3)); self.grid.trap((1, 3)); self.grid.trap((2, 3))
        '''-----------------------------------'''
